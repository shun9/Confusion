...
{
	Matrix matrix;
	matrix.m_matrix[1][1] =  cos(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[1][2] = -sin(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[2][1] =  sin(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[2][2] =  cos(DirectX::XMConvertToRadians(angle));
...
{
	Matrix matrix;
	matrix.m_matrix[0][0] =  cos(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[0][2] =  sin(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[2][0] = -sin(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[2][2] =  cos(DirectX::XMConvertToRadians(angle));
...
Matrix Matrix::CreateRotationZ(float angle)
{
	Matrix matrix;
	matrix.m_matrix[0][0] =  cos(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[0][1] = -sin(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[1][0] =  sin(DirectX::XMConvertToRadians(angle));
	matrix.m_matrix[1][1] =  cos(DirectX::XMConvertToRadians(angle));
